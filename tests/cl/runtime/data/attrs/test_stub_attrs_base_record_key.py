...
def test_smoke():
    ...
    key_a0 = StubAttrsBaseRecordKey(record_id='A', record_index=0)
    key_b0 = StubAttrsBaseRecordKey(record_id='B', record_index=0)
...
def test_composite_key():
    ...
    base_key_1 = StubAttrsBaseRecordKey(record_id='A', record_index=0)
    base_key_same_as_1 = StubAttrsBaseRecordKey(record_id='A', record_index=0)
    base_key_2 = StubAttrsBaseRecordKey(record_id='B', record_index=1)
