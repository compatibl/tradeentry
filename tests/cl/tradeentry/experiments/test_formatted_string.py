...
from utils.trade_checker import TradeChecker
from utils.tag_utils import fields_to_text, add_line_numbers
...
def test_notional_schedule_swap():
    ...
    _test_formatted_string(FIELDS, numbered_notional_schedule_swap)
