...
class StubRuntimeConfig(Config):
    ...
    def configure(self) -> None:
        ...
        stub_dataclass_derived_from_derived_records = [StubDataclassDerivedFromDerivedRecord(id=f"D{i}") for i in
                                                       range(10)]
        ...
        stub_dataclass_primitive_fields_records = [StubDataclassPrimitiveFields(key_str_field=f"K{i}") for i in
                                                   range(10)]
